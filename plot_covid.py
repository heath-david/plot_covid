...
colors = {'Canada':'#045275', 'China':'#089099', 'France':'#7CCBA2', 'Germany':'#FCDE9C', 'Morocco':'#FF7F50', 'US':'#DC3977', 'United Kingdom':'#7C1D6F'}
...
plot.text(x = covid.index[1], y = int(covid.max().max())+60000, s = "COVID-19 Cases by Country", fontsize = 15, weight = 'bold', alpha = .75)
plot.text(x = covid.index[1], y = int(covid.max().max())+30000, s = "For the USA, China, Germany, France, United Kingdom, Canada, and Morocco\nIncludes Current Cases, Recoveries, and Deaths", fontsize = 10, alpha = .75)
...
percapitaplot.text(x = percapita.index[1], y = percapita.max().max()+30, s = "Per Capita COVID-19 Cases by Country", fontsize = 15, weight = 'bold', alpha = .75)
percapitaplot.text(x = percapita.index[1], y = percapita.max().max()+15, s = "For the USA, China, Germany, France, United Kingdom, Canada, and Morocco\nIncludes Current Cases, Recoveries, and Deaths", fontsize = 10, alpha = .75)
percapitaplot.text(x = percapita.index[1], y = -55,s = 'Source: https://github.com/datasets/covid-19/blob/master/data/countries-aggregated.csv\nModified from Nik Piepenbreier', fontsize = 6)
